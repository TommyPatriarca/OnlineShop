...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (strlen($password) < 8 || !preg_match('/[A-Z]/', $password) || !preg_match('/[0-9]/', $password)) {
        echo "<script>alert('La password deve avere almeno 8 caratteri, contenere almeno una lettera maiuscola e un numero');</script>";
    } else {
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            echo "<script>alert('Errore: " . $sql . "<br>" . $conn->error . "');</script>";
        }
